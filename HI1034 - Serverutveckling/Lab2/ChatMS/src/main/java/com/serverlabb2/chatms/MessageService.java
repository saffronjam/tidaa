...
import com.serverlabb2.utilities.bodies.IdStringBody;
...
public class MessageService {
    ...
    public void add(MessageForm messageForm) {
        try {
            ...
            // Fetch user id
            var userIdBody = Requests.getJsonObject(Requests.createGet("http://user-ms:8084/validate/" + messageForm.token()), IdBody.class);
            if (userIdBody.id() == -1) {
