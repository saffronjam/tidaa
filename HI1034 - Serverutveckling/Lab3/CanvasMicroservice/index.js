...
MongoClient.connect('mongodb+srv://serverlabb3:serverlabb3@cluster0.tz3ua.mongodb.net/serverlabb3?authSource=admin&replicaSet=atlas-fdxvtm-shard-0&readPreference=primary&appname=MongoDB%20Compass&ssl=true', function (err, client) {
    if (err) {
        console.error(err)
    }
