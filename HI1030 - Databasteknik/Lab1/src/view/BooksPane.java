...
public class BooksPane extends VBox {
    ...
    public BooksPane(ElemBooksDb booksDb) {
    ...
    private void initMenus(Controller controller)
    {
        ...
        addBookItem.setOnAction((final ActionEvent e) ->
        {
            ...
            dialog.getKey().setResultConverter(dialogButton -> {
                if (dialogButton == dialog.getValue())
                {
                    ...
                    return new Book(isbn.getText(), title.getText(), convertedDate, chosenAuthors, storyline.getText(), chosenGenres, controller.getUserSession().getUser(), 0.0f );
                }
                return null;
            });
        ...
        viewReviewstem.setOnAction((final ActionEvent e) ->
        {
            ...
            var reviews = controller.getAllReviewsForBook(controller.getSelectedBook());
            if(reviews.isEmpty())
            {
